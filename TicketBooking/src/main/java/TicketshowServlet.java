...
public class TicketshowServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        try {
            ...
            String query = "SELECT pd.*, br.bording_point, br.droping_point, br.date, bd.timing, bd.ticket_price, ns.bus_name, ns.seat_no " +
                    ...
                    "INNER JOIN name_seat ns ON br.route_id = ns.bus_id " +
